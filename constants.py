...
cardlist = []
cardlist.append(card.Card(0, 60, streetimagelist[0], 30))
cardlist.append(card.Card(1, 60, streetimagelist[1], 30))
cardlist.append(card.Card(2, 200, streetimagelist[2], 100))
cardlist.append(card.Card(3, 100, streetimagelist[3], 50))
cardlist.append(card.Card(4, 100, streetimagelist[4], 50))
cardlist.append(card.Card(5, 120, streetimagelist[5], 60))
cardlist.append(card.Card(6, 140, streetimagelist[6], 70))
cardlist.append(card.Card(7, 150, streetimagelist[7], 70))
cardlist.append(card.Card(8, 140, streetimagelist[8], 30))
cardlist.append(card.Card(9, 160, streetimagelist[9], 80))
cardlist.append(card.Card(10, 200, streetimagelist[10], 100))
cardlist.append(card.Card(11, 180, streetimagelist[11], 90))
cardlist.append(card.Card(12, 180, streetimagelist[12], 90))
cardlist.append(card.Card(13, 200, streetimagelist[13], 100))
cardlist.append(card.Card(14, 220, streetimagelist[14], 110))
cardlist.append(card.Card(15, 220, streetimagelist[15], 110))
cardlist.append(card.Card(16, 240, streetimagelist[16], 120))
cardlist.append(card.Card(17, 200, streetimagelist[17], 100))
cardlist.append(card.Card(18, 260, streetimagelist[18], 130))
cardlist.append(card.Card(19, 260, streetimagelist[19], 130))
cardlist.append(card.Card(20, 150, streetimagelist[20], 75))
cardlist.append(card.Card(21, 280, streetimagelist[21], 140))
cardlist.append(card.Card(22, 300, streetimagelist[22], 150))
cardlist.append(card.Card(23, 300, streetimagelist[23], 150))
cardlist.append(card.Card(24, 320, streetimagelist[24], 160))
cardlist.append(card.Card(25, 200, streetimagelist[25], 100))
cardlist.append(card.Card(26, 350, streetimagelist[26], 175))
cardlist.append(card.Card(27, 400, streetimagelist[27], 200))

chancelist=[]
number=0
for cards in chanceimagelist:
    chancelist.append(card.Card(number,0,chanceimagelist[number],0))
    number+=1
...
for cards in communityimagelist:
    communitylist.append(card.Card(number,0,communityimagelist[number],0))
    number+=1
